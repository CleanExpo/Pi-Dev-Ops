        ...
        for eval_attempt in range(max_retries + 1):
            ...
            try:
                ...
                eval_spec = (
                    ...
                    "2. CORRECTNESS \u2014 Any bugs, logic errors, type issues, null refs, "
                    "security vulnerabilities, or broken tests? One confirmed bug = ≤6.\n"
                    "3. CONCISENESS \u2014 Any dead code, debug prints, TODO stubs, or "
                    "over-engineered abstractions? Tight, purposeful code = 9-10.\n"
                    ...
                    "OVERALL: <average>/10 \u2014 PASS or FAIL (threshold: "
