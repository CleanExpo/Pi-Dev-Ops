...
# ── RA-890: Re-export SDK helpers from session_sdk.py ────────────────────────
from .session_sdk import (  # noqa: F401 (re-exports)
    _SDK_METRICS_DIR,
    _write_sdk_metric,
    _emit_sdk_canary_metric,
    _run_claude_via_sdk,
)
# ── RA-890: Re-export evaluator helpers from session_evaluator.py ─────────────
from .session_evaluator import (  # noqa: F401 (re-exports)
...
# ── RA-890: Re-export Linear sync helpers from session_linear.py ──────────────
from .session_linear import (  # noqa: F401 (re-exports)
...
# _get_claude_md / _claude_md_cache are now in session_evaluator.py.
...
# _get_claude_md moved to session_evaluator.py (re-exported above).

# _SDK_METRICS_DIR, _write_sdk_metric, _emit_sdk_canary_metric are now in
# session_sdk.py and re-exported at the top of this file.
...
# _parse_evaluator_dimensions, _extract_eval_score, _extract_eval_confidence,
# _send_low_confidence_alert, _get_claude_md, _run_eval_with_cache,
# _run_parallel_eval_cached, _run_single_eval, _run_parallel_eval are now in
# session_evaluator.py and re-exported at the top of this file.

# _run_claude_via_sdk is now in session_sdk.py and re-exported at the top of this file.
...
# _update_linear_state, _post_linear_comment, _record_session_outcome,
# _sync_linear_on_completion are now in session_linear.py and re-exported above.
