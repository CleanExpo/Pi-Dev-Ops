...
async def run_tdd(
    ...
    *,
    ...
    # Lookahead horizon: explicit arg wins; else OM-1 / TAO_PLANNER_HORIZON config.
    from .tao_planner import resolve_planner_loop_kwargs

    planner_kwargs = resolve_planner_loop_kwargs(planner_horizon=planner_horizon)
