...
"
        "Set it via 1Password: op item get js76udv2l2ncapgdt27reg65hi --reveal --fields credential
"
        "Or for one-shot use: SUPABASE_SERVICE_ROLE_KEY=... python3 scripts/sync_harness_to_supabase.py
"
        "RA-3034: hardcoded fallback removed 2026-05-12; key rotation pending in RA-2989."
    )
