...
1. Review new SDK/MCP changes — check whether Pi-Dev-Ops `app/server/` or `mcp/pi-ceo-server.js` needs updates to adopt new capabilities.
...
- `claude-code-overview.md` — 2026-04-12 20:57 UTC — Claude Code Overview
- `claude-code-cli-reference.md` — 2026-04-12 20:57 UTC — Claude Code Cli Reference
- `api-reference.md` — 2026-04-12 20:57 UTC — Api Reference
