...
> **Vendored from `nexu-io/open-design`** (Apache-2.0) on 2026-05-05.
> Upstream: https://github.com/nexu-io/open-design/tree/main/assets/frames
>
> Use from Remotion: in a composition, embed `<iframe src={`/assets/frames/iphone-15-pro.html?screen=${encodeURIComponent(screenUrl)}`} />` to wrap any rendered screen in a device bezel. Refer here from `remotion-composition-builder` when the brief calls for a product mockup, app walkthrough, or social cut featuring UI screenshots.
