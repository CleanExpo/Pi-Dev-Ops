...
__export(index_exports, {
  ...
  MARGOT_CANONICAL_AVATAR_PATH: () => MARGOT_CANONICAL_AVATAR_PATH,
  MARGOT_DISPLAY_NAME: () => MARGOT_DISPLAY_NAME,
  MARGOT_ELEVENLABS_VOICE_ID: () => MARGOT_ELEVENLABS_VOICE_ID,
  brands: () => brands,
  carsi: () => carsi,
  ccw: () => ccw,
  dr: () => dr,
  getMargotSurface: () => getMargotSurface,
  margotSurfaces: () => margotSurfaces,
  nrpg: () => nrpg,
